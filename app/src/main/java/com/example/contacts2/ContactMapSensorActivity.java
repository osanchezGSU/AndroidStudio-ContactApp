...
public class ContactMapSensorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contact_map_sensor);
        initListButton();
        initSettingButton();
        initMapButton();
        initGetLocation();
    ...
    private void initListButton() {
        ...
        ibList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ContactMapSensorActivity.this, ContactListActivity.class);
    ...
    private void initSettingButton() {
        ...
        ibList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ContactMapSensorActivity.this, ContactSettingsActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
            ...
            public void onClick(View v) {
                ...
                try{
                    if(Build.VERSION.SDK_INT >= 23) {
                        if(ContextCompat.checkSelfPermission(ContactMapSensorActivity.this,
                                Manifest.permission.ACCESS_FINE_LOCATION)!=
                                PackageManager.PERMISSION_GRANTED){
                            if (ActivityCompat.shouldShowRequestPermissionRationale(ContactMapSensorActivity.this,
                                    Manifest.permission.ACCESS_FINE_LOCATION)){
                                ...
                                ActivityCompat.requestPermissions(ContactMapSensorActivity.this, new
        ...
        switch (requestCode) {
            case PERMISSION_REQUEST_LOCATION: {
                if (grantResults.length > 0 &&
                    ...
                    Toast.makeText(ContactMapSensorActivity.this,
